...
// echo(straight_channel_xy(width, height, length, [1, 0, 0]));
// echo(straight_channel_xy(width, height, length, [1, 1, 0]));
// echo(straight_channel_xy(width, height, length, [0, 1, 0]));
// echo(straight_channel(width, height, length, [-1, -1, 1]));
